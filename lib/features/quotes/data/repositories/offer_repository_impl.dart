...
class OfferRepositoryImpl implements OfferRepository {
  ...
  OffersCompanion _toCompanion(Offer offer) => OffersCompanion.insert(
    ...
    customerPhone: Value(_nullIfBlank(offer.customerPhone)),
    customerEmail: Value(_nullIfBlank(offer.customerEmail)),
    customerAddress: Value(_nullIfBlank(offer.customerAddress)),
    customerTaxOffice: Value(_nullIfBlank(offer.customerTaxOffice)),
    customerTaxNumber: Value(_nullIfBlank(offer.customerTaxNumber)),
